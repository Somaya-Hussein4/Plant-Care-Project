...
mixin _$NotificationState {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<NotificationModel> notifications, int unreadCount,
            WeatherForecastModel? weatherForecast, bool isWeatherLoading)?
        loaded,
...
// null = not fetched yet, stays null if permission denied or API failed
  ...
  @override
  String toString() {
    return 'NotificationState.loaded(notifications: $notifications, unreadCount: $unreadCount, weatherForecast: $weatherForecast, isWeatherLoading: $isWeatherLoading)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(
        notifications, unreadCount, weatherForecast, isWeatherLoading);
  }
...
abstract class _Loaded implements NotificationState {
  const factory _Loaded(
      ...
      final int unreadCount,
      final WeatherForecastModel? weatherForecast,
      final bool isWeatherLoading}) = _$LoadedImpl;

  List<NotificationModel> get notifications;
  int get unreadCount; // null = not fetched yet, stays null if permission denied or API failed
