...
mixin _$HistoryState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<HistoryScanModel> scans, bool hasMore)
        success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<HistoryScanModel> scans, bool hasMore)? success,
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<HistoryScanModel> scans, bool hasMore});
}
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(
      {required final List<HistoryScanModel> scans, required this.hasMore})
      : _scans = scans;

  final List<HistoryScanModel> _scans;
  @override
  List<HistoryScanModel> get scans {
  ...
  @override
  String toString() {
    return 'HistoryState.success(scans: $scans, hasMore: $hasMore)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_scans), hasMore);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(scans, hasMore);
  }
...
abstract class _Success implements HistoryState {
  const factory _Success(
      {required final List<HistoryScanModel> scans,
