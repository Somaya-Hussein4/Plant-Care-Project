...
mixin _$ProfileState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ProfileUserModel user) loaded,
    required TResult Function(ProfileUserModel user) uploading,
    required TResult Function(ProfileUserModel user) uploadSuccess,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(ProfileUserModel user)? loaded,
    TResult? Function(ProfileUserModel user)? uploading,
    TResult? Function(ProfileUserModel user)? uploadSuccess,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({ProfileUserModel user});
}
...
abstract class _Loaded implements ProfileState {
  const factory _Loaded(final ProfileUserModel user) = _$LoadedImpl;
...
class _$UploadingImpl implements _Uploading {
  const _$UploadingImpl(this.user);
  ...
  @override
  String toString() {
    return 'ProfileState.uploading(user: $user)';
  }
...
abstract class _Uploading implements ProfileState {
  const factory _Uploading(final ProfileUserModel user) = _$UploadingImpl;
...
abstract class _UploadSuccess implements ProfileState {
  const factory _UploadSuccess(final ProfileUserModel user) =
      _$UploadSuccessImpl;
